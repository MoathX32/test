...
def generate_questions_endpoint():
    ...
    try:
        ...
        # Debugging: Output the structure and type of reference_texts
        ...
        if not isinstance(reference_texts, list):
            st.error("Reference texts are not in the expected format (list of dictionaries).")
            return
        ...
        # Debugging: Output the type of relevant_texts before model initialization
        st.write("Debug: Type of relevant_texts:", type(relevant_texts))

        # Ensure that relevant_texts is a string after joining
        if not isinstance(relevant_texts, str):
            st.error("relevant_texts should be a string after joining.")
            return
