...
def get_response(context, question, model):
    ...
    اذا كان السؤال ناقص استفهم من الطالب المقصود
    أجب على السؤال التالي من خلال فهمك النص الموجود في السياق المرجعي . قدم إجابة واضحة تتناسب مع مستوى الصفوف الأولى.
    لا تجب على أي سؤال خارج سياق او مشابهاته.
    السياق: {context}\n
    السؤال: {question}\n
    """
